...
namespace gz
{
  namespace launch
  {
    ...
    class WebsocketServer : public gz::launch::Plugin
    {
      ...
      //Inbound buffer to defragmentize with. We're doing a fixed size buffer which should be enough for our inbound traffic. We can make a dynamic buffer in the future.
      //TODO: move into class, so this can be private.
      public: std::string rx_buf[128];
      public: int rx_buf_idx = 0;
